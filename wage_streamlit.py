...
st.header('年齢階級別の一人当たり賃金（全国）')

df_mean_bubble = df_jp_ind[df_jp_ind['年齢'] != '年齢計']

# x軸：年間給料　y軸：ボーナス　size：月給 集計単位：年齢・集計年
